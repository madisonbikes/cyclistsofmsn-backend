...
## [3.0.0](https://github.com/madisonbikes/cyclistsofmsn-backend/compare/cyclistsofmsn-backend-v2.1.0...cyclistsofmsn-backend-v3.0.0) (2025-06-16)
...
* add NVM version selector to workspace settings ([f5a2b23](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/f5a2b23b41b47a224f24af58f2d2f9eb6245fd60))
* add password support for valkey uri ([c887b84](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/c887b840f9e68e90f14317222bb3328e59649334))
...
* alt text is required for atproto 0.14.x ([cc38fda](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/cc38fda6e209e825166e6bd3daab8a442807b640))
* bump @atproto/api from 0.13.18 to 0.13.24 ([59e757f](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/59e757f0487ffc9e87bdacc4ec51aa771c389a5a))
...
* bump @atproto/api from 0.13.24 to 0.13.32 ([33fad9c](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/33fad9cdf6419f2e4b98e7e00ac8df7bd0957fd3))
* bump @atproto/api from 0.13.24 to 0.13.32 ([6da8a69](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/6da8a69d738e95955f9fa2461cb0cb6c1a5d48af))
* bump @atproto/api from 0.13.32 to 0.14.7 ([ebe71cb](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/ebe71cbe78d8bee5904b32a3374f4fad4f9f05f4))
* bump @atproto/api from 0.13.32 to 0.14.7 ([f13ecd7](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/f13ecd71e1af128fa6e41fcb671436a5f9d08f34))
* bump @atproto/api from 0.14.16 to 0.15.5 ([9d6018b](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/9d6018b27f5ec25f5861edef6a2d039a89defc92))
* bump @atproto/api from 0.14.16 to 0.15.5 ([cd430de](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/cd430de1cdc2275a6ba31327676216b799524af8))
* bump @atproto/api from 0.14.7 to 0.14.16 ([13c1595](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/13c1595f0dc0996501ca750fc3152452bcb035a1))
* bump @atproto/api from 0.14.7 to 0.14.16 ([1090cf5](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/1090cf56227aabd8329b1cf2f521d6dd8ec9942f))
* bump @atproto/api from 0.15.5 to 0.15.12 ([9a449ea](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/9a449ea8d34b37722d5239091331d2b8b79fa490))
* bump @atproto/api from 0.15.5 to 0.15.12 ([56e4afe](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/56e4afecfad842bb3f0f95a2da92129d07bd4e54))
* bump @keyv/valkey from 1.0.0 to 1.0.1 ([96dbe2b](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/96dbe2b5a81295407f269ee20ecaeb1cd4866383))
...
* bump @keyv/valkey from 1.0.1 to 1.0.2 ([b29f236](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/b29f236d12ed6855b3f12c41caa2161f75cc8d7a))
* bump @keyv/valkey from 1.0.1 to 1.0.2 ([ccc54ff](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/ccc54ffbf78b48c3a0f9b640976a3f80ff6fe38b))
* bump @keyv/valkey from 1.0.2 to 1.0.3 ([cdd5ee1](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/cdd5ee118aa6c333a054be645602ee731582339a))
* bump @keyv/valkey from 1.0.2 to 1.0.3 ([8888ec5](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/8888ec5c9adb216eabd15d0e58e125f22cd64ea4))
* bump @typegoose/typegoose from 12.10.1 to 12.12.0 ([cf177e5](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/cf177e58fd258e05ef3d5ff51952d779a12757cf))
* bump @typegoose/typegoose from 12.10.1 to 12.12.0 ([b0c4906](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/b0c4906b4960225a7076f94f3959a3d0f00e0da4))
* bump @typegoose/typegoose from 12.12.0 to 12.15.0 ([a8c92fd](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/a8c92fd9352689c6ada6898e53cad30dcef1310f))
* bump @typegoose/typegoose from 12.12.0 to 12.15.0 ([8e7d1c3](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/8e7d1c30b825f4549bc349ccf2b94d04ddfd76bf))
* bump @typegoose/typegoose from 12.15.0 to 12.16.0 ([f8ebcef](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/f8ebcef81ccba2a8933a79357e1fb6817b205602))
* bump @typegoose/typegoose from 12.15.0 to 12.16.0 ([a60d0b0](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/a60d0b0a1d1d84ee7a5d1baa59aecfe52bc98738))
* bump @typegoose/typegoose from 12.8.0 to 12.9.1 ([6a1035d](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/6a1035d81e77913399faa130cf631810066b6929))
...
* bump @typegoose/typegoose from 12.9.1 to 12.10.1 ([8913ccd](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/8913ccd278a81a72653b36530085b575d56e7b8c))
...
* bump bcryptjs from 2.4.3 to 3.0.2 ([2506cd7](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/2506cd7771ac7448fc1bacb21b9bec147d7995d8))
* bump bcryptjs from 2.4.3 to 3.0.2 ([e6a2431](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/e6a24316e488957a3f6dde0192661c0df400261a))
* bump connect-redis from 8.0.3 to 8.1.0 ([07eec96](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/07eec96fb19fd973ca6260885f05b4044f436d4b))
* bump connect-redis from 8.0.3 to 8.1.0 ([6d933aa](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/6d933aad48b7c2f569b99c377394385478119623))
* bump dotenv from 16.4.5 to 16.4.7 ([6a18486](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/6a1848643d077cd9f2d1f3e8237329495e60aa7d))
...
* bump dotenv from 16.4.7 to 16.5.0 ([09e415f](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/09e415f9b26142c36cfa13b76738387ca4f0e1dd))
* bump dotenv from 16.4.7 to 16.5.0 ([86b04b5](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/86b04b5f452f6107ac2c0d17f2e2a9343808d45a))
* bump exifreader from 4.25.0 to 4.26.0 ([ab5395b](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/ab5395b2cc243a60fb8b06a4ab9f9a409ae90153))
...
* bump exifreader from 4.26.0 to 4.26.1 ([5e24ba4](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/5e24ba4689b72cabbc86eb5e4dacdbbfb1ae17ef))
* bump exifreader from 4.26.0 to 4.26.1 ([a0fb1d3](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/a0fb1d347b23f062983bd1e42e47390036cf982f))
* bump exifreader from 4.26.1 to 4.27.0 ([5a96a1d](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/5a96a1d81cf25ef582f34800d07b4b1e1092c179))
* bump exifreader from 4.26.1 to 4.27.0 ([93a757f](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/93a757fc38ddb5c8f3961cf01ca6b315db566be6))
* bump exifreader from 4.27.0 to 4.29.0 ([cba0ced](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/cba0ceda58732202ec1df2827b3fed0fb63d654b))
* bump exifreader from 4.27.0 to 4.29.0 ([8626c5d](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/8626c5d5be728c41f4a6307f94966778e1131556))
* bump exifreader from 4.30.0 to 4.31.0 ([c6f5f8e](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/c6f5f8e1a0f4b0306af3e972dc5c2ad005bbb204))
* bump exifreader from 4.30.0 to 4.31.0 ([6555e8a](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/6555e8ae18f3d90b874c0d2829be93033e193641))
* bump express from 5.0.1 to 5.1.0 ([b592902](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/b5929028e40249f7bd9107bd8e7cbd9370d442e9))
* bump express from 5.0.1 to 5.1.0 ([c3ede14](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/c3ede14ad000fff3a45fa62c9db5d9a42a58dee0))
* bump fs-extra from 11.2.0 to 11.3.0 ([882c225](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/882c2255c22b5bdb75ed1c6da885268b31b123a6))
* bump fs-extra from 11.2.0 to 11.3.0 ([01bafcc](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/01bafcc7cdc05c0916d4730b9b52ec030af70c47))
* bump iovalkey from 0.3.1 to 0.3.2 ([e4dd672](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/e4dd6722acde81c8041b13ebe2509da978f39353))
* bump iovalkey from 0.3.1 to 0.3.2 ([8aef64c](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/8aef64c1bd13f5037615f3bb1cb4627dd63559e2))
* bump keyv from 5.1.2 to 5.2.1 ([46ed818](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/46ed818382c83b01ea127ce6bdf8f76dba1a58fd))
...
* bump keyv from 5.2.1 to 5.2.3 ([a060ac5](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/a060ac5c275412bb054b839be27d929ea7b60edb))
...
* bump keyv from 5.2.3 to 5.3.2 ([7151ea8](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/7151ea86ee6abd54a3becb882ff01bdbff5e572f))
* bump keyv from 5.2.3 to 5.3.2 ([0f5ed97](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/0f5ed97077cd0c3372f9c33952e91ec242111457))
* bump keyv from 5.3.2 to 5.3.3 ([ef8782d](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/ef8782df4cd8c9eb8eadc9a7a653eabbf1f91cb3))
* bump keyv from 5.3.2 to 5.3.3 ([61746b8](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/61746b898d21be516b3bce5c3c9f61b3349e2c5c))
* bump mongodb from 6.12.0 to 6.13.0 ([8154382](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/81543824ecf34d4b7dec61e64c9007b2244f4fea))
* bump mongodb from 6.12.0 to 6.13.0 ([3b386be](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/3b386beaf9363208ebf79043d949cad717dc4599))
* bump mongodb from 6.13.0 to 6.14.0 ([c0e1fc0](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/c0e1fc03321ad875ad42ca60ee55324ec86a2269))
* bump mongodb from 6.13.0 to 6.14.0 ([5e4532d](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/5e4532dc7caa4baeb95098d8e04d0054d118090d))
* bump mongodb from 6.14.0 to 6.15.0 ([1c01056](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/1c010566bed9256f0b3a9ac3004610d04e154a23))
* bump mongodb from 6.14.0 to 6.15.0 ([19d97c0](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/19d97c0e39692a9ca141c9a5d64c1f03bb94cf94))
* bump mongodb from 6.15.0 to 6.16.0 ([5dc1ac0](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/5dc1ac034d4f45317bdf486a38b6095d1fc2e2a9))
* bump mongodb from 6.15.0 to 6.16.0 ([aaa0df8](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/aaa0df8f0765133db503cf8af19b34f1bd1286de))
* bump mongoose from 8.8.3 to 8.8.4 ([96c2ac5](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/96c2ac5326a17d66959e0aae7830a381e5f34a26))
...
* bump mongoose from 8.9.3 to 8.9.6 ([df47795](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/df47795ecd022504d2131d4ae8fac3ff0bdd467c))
* bump mongoose from 8.9.3 to 8.9.6 ([ccab94f](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/ccab94f26a3ec38d76e10a6ec783c5df247b9bb9))
* bump pino from 9.5.0 to 9.6.0 ([63cf917](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/63cf9179c7401809d0d7ab9ddaa8af7837b075a9))
...
* bump pino from 9.6.0 to 9.7.0 ([48719ed](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/48719ed5ee312bab8e628650ce122f708d79cd24))
* bump pino from 9.6.0 to 9.7.0 ([9a55a95](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/9a55a95b1cfae63c5a1471e610215c3b64c19e26))
* bump pino-pretty from 11.3.0 to 13.0.0 ([d507f4d](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/d507f4d9f3adc9994af14369ebcd658b477a2092))
...
* bump superagent from 10.1.1 to 10.2.0 ([ef5d5d9](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/ef5d5d92683472b79accaee3b84badef973cd3ba))
* bump superagent from 10.1.1 to 10.2.0 ([46f1928](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/46f1928fb0ec9090c8bebcb203f9e4efedcf4a15))
* bump superagent from 10.2.0 to 10.2.1 ([2692510](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/26925102955086a70e2404a83bae7867963ea95e))
* bump superagent from 10.2.0 to 10.2.1 ([aeef261](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/aeef261e2d9d6266d6a5a320a6cd9d059255aecb))
* bump zod from 3.23.8 to 3.24.1 ([891d291](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/891d2918ab5fa6e90042337743100218506fafa8))
...
* bump zod from 3.24.1 to 3.24.2 ([12fcb18](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/12fcb18be3792a8e318d0046deefe7175c070e0f))
* bump zod from 3.24.1 to 3.24.2 ([f2cb514](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/f2cb514f3a24c839fcda28e1309325022e1b3668))
* bump zod from 3.24.2 to 3.24.3 ([4777187](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/4777187d6a6d036d91e15b0e83466c5169e6d902))
* bump zod from 3.24.2 to 3.24.3 ([70cc372](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/70cc372c96a7495c5f656557522b1e577d851bb3))
* bump zod from 3.24.3 to 3.25.45 ([1139561](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/1139561f9dcb0dcc8bc9e71bc152094d77eddce8))
* bump zod from 3.24.3 to 3.25.45 ([6c7bd57](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/6c7bd5705cda8c1ebb41f71361b00b55a6de08d2))
* migrate away from redis for session stores ([7d2b60b](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/7d2b60b7c56530d345377413a182e41ef6942c97))
* remove export from ValkeyConfiguration interface ([79c2de4](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/79c2de4e007936a38ac56233108cdcdb55e1760d))
* remove pino-pretty for production ([c62ae62](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/c62ae62f385bf325549ac79d59a897786f96ceac))
* remove unnecessary bcryptjs types ([e7c9f4c](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/e7c9f4ce62fa1f13d06f4b1704dc87b7b5813780))
* remove unused package iovalkey ([55560dd](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/55560ddaf9f5dae17e0e0db99f67db4ed3e89187))
* update connect-redis to version 8.0.3 ([dd81e7f](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/dd81e7f69f2683dd8e34cc1ed68fd9b125ee9d49))
* update documentation for PersistentCache storage options ([90e6b5b](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/90e6b5b1efc5f97b3adce128d996c23f1aad67f0))
* update package-lock.json ([9eb813a](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/9eb813a8c3483a78210ba31f90d894777b090884))
* update to node 22 ([7fa431e](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/7fa431ed9f85c122f5f4a40de9f8d7cc8e49ca69))
* use iovalkey since it's already used for keyv/valkey ([0a38d4a](https://github.com/madisonbikes/cyclistsofmsn-backend/commit/0a38d4a4fc0b68a02cad5ec423961f07ab3b7766))
